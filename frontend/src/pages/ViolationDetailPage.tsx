  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-2 ml-[-2px]">
        <div className="w-6 h-6 rounded-full bg-ink-black dark:bg-canvas-cream flex items-center justify-center shrink-0">
          <svg
            className="w-3.5 h-3.5 text-canvas-cream dark:text-ink-black"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            viewBox="0 0 24 24"
        ...
        <div>
          <p className="text-xs font-bold tracking-tight text-ink-black dark:text-canvas-cream leading-none">
            CloudLine
          </p>
          <p className="text-[9px] text-slate-gray mt-0.5">AWS Security</p>
        </div>
      </div>
      ...
      {!violation ? (
        ...
        <>
          ...
          <div className="bg-lifted-cream dark:bg-ink-black border border-ghost-cream dark:border-white/5 rounded-hero px-6 py-5 shadow-elev-1">
            ...
            <EyebrowLabel>Violation Detail</EyebrowLabel>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="lg:col-span-2 bg-lifted-cream dark:bg-ink-black border border-ghost-cream dark:border-white/5 rounded-hero px-6 py-5 shadow-elev-1 flex flex-col">
              ...
              {(violation.first_detected || violation.last_evaluated) && (
                <div className="flex gap-8 pt-3 mt-auto border-t border-ghost-cream dark:border-white/5">
          ...
          {/* Remediation */}
          <div>
            <h3 className="text-sm font-semibold text-ink-black dark:text-canvas-cream mb-3">
              How to Fix
            </h3>
            <RemediationTabs
