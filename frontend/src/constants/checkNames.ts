...
const CHECK_NAMES: Record<string, string> = {
  ...
  apigw_lb_deletion_protection: "Production Load Balancer Deletion Protection Off",
  ...
  storage_ebs_default_encryption: "EBS Default Encryption Not Enabled at Account Level",
  ...
  cloudwatch_unauthorized_api_alarm: "No CloudWatch Alarm for Unauthorized API Calls",
  cloudwatch_no_mfa_login_alarm: "No CloudWatch Alarm for Console Login Without MFA",
  ...
  cloudwatch_s3_policy_alarm: "No CloudWatch Alarm for S3 Bucket Policy Changes",
  ...
  cloudwatch_igw_changes_alarm: "No CloudWatch Alarm for Internet Gateway Changes",
  ...
  cloudwatch_failed_login_alarm: "No CloudWatch Alarm for Failed Console Sign-In",
  ...
  cloudwatch_org_changes_alarm: "No CloudWatch Alarm for AWS Organizations Changes",
  ...
  awssec_inspector_critical_cve_30d: "Inspector CRITICAL CVE Open More Than 30 Days",
