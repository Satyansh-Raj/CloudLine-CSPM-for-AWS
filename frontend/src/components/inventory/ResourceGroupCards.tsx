...
/** Multi-path SVG icon per technology_category. */
...
const CATEGORY_COLORS: Record<string, string> = {
  storage: "border-blue-200 dark:border-blue-800/40",
  compute: "border-orange-200 dark:border-orange-800/40",
  database: "border-purple-200 dark:border-purple-800/40",
  network: "border-cyan-200 dark:border-cyan-800/40",
  identity: "border-yellow-200 dark:border-yellow-800/40",
  serverless: "border-emerald-200 dark:border-emerald-800/40",
        ...
        >
          ...
          {onCategoryClick ? (
            <button
              ...
              className="w-full flex items-center justify-between px-5 py-3 border-b border-gray-100 dark:border-white/5 text-left"
            >
          ...
          <div className="divide-y divide-gray-50 dark:divide-white/[0.03]">
            {g.resources.map((r) => (
              <div
                ...
                className="flex items-center justify-between px-5 py-2.5 hover:bg-gray-50 dark:hover:bg-white/[0.03] transition-colors"
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] font-mono text-gray-400 dark:text-gray-500 truncate max-w-[260px]">
                      {r.resource_id}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 shrink-0">
                  <span className="text-[10px] font-medium uppercase tracking-wider text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-white/5 px-1.5 py-0.5 rounded">
                    {r.service}
                  </span>
                  ...
                  {r.violation_count > 0 ? (
                    ...
                    <span className="text-xs text-gray-300 dark:text-gray-600 min-w-[16px] text-right">
                      0
                    </span>
                  )}
                  <span
